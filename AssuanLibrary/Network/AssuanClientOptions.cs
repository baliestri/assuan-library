...
public sealed class AssuanClientOptions(IPAddress ipAddress, PortAndNonce portAndNonce) : IEquatable<AssuanClientOptions> {
  /// <summary>
  ...
  /// </summary>
  /// <param name="portAndNonce">The port and nonce information to use when connecting.</param>
  public AssuanClientOptions(PortAndNonce portAndNonce) : this(IPAddress.Loopback, portAndNonce) { }
  ...
  /// </summary>
  public AssuanClientOptions() : this(IPAddress.Loopback, PortAndNonce.Empty) { }
  ...
  public void Deconstruct(out IPAddress ipAddress, out PortAndNonce portAndNonce) {
    ipAddress = IpAddress;
